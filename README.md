# Quake and Hexen II MDL Importer and Exporter for Blender 4.0+
Import and Export ID's Quake and Ravensoft's Hexen II MDL models to and from Blender 4.0+
...
This versions is updated to work with Blender 4.0 or greater and has some new features such as support for Hexen II palette.
